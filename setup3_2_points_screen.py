...
def setup3_2_points_screen():
    ...
    coins_button = ctk.CTkButton(root, command=lambda: (root.withdraw(), setup3_2_points_screen()), text="", fg_color="#e5d2e9", corner_radius=20, image=coins_button_image)
    ...
    xp_button = ctk.CTkButton(root, command=lambda: (root.withdraw(), dashboard()), text="", fg_color="#e5d2e9", corner_radius=20, image=xp_button_image)
